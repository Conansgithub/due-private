...
const (
	defaultNameKey          = "etc.echo.name"
	defaultAddrKey          = "etc.echo.addr"
	defaultConsoleKey       = "etc.echo.console"
	defaultBodyLimitKey     = "etc.echo.bodyLimit"
	defaultConcurrencyKey   = "etc.echo.concurrency"
	defaultStrictRoutingKey = "etc.echo.strictRouting"
	defaultCaseSensitiveKey = "etc.echo.caseSensitive"
	defaultKeyFileKey       = "etc.echo.keyFile"
	defaultCertFileKey      = "etc.echo.certFile"
	defaultCorsKey          = "etc.echo.cors"
	defaultSwaggerKey       = "etc.echo.swagger"
)
...
type SwagOptions struct {
	...
	SwaggerBundleUrl string `json:"swaggerBundleUrl"` // swagger-ui-bundle.js地址(静态资源URL)
	SwaggerPresetUrl string `json:"swaggerPresetUrl"` // swagger-ui-standalone-preset.js地址(预设静态资源URL)
	SwaggerStylesUrl string `json:"swaggerStylesUrl"` // swagger-ui.css地址(样式静态资源URL)
}
